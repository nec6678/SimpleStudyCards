...
VIEWING SAVED SETS (added v1.0.2)
- At the option select menu, type '3' and press enter
- The sets in the same folder as the Python script in the pythonscript folder will be listed

DELETING A SET (added v1.0.1)
